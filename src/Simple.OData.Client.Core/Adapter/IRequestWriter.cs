...
namespace Simple.OData.Client
{
    public interface IRequestWriter
    {
        ...
        Task<ODataRequest> CreatePutRequestAsync(string commandText, Stream stream, string contentType, bool optimisticConcurrency, IDictionary<string, string> headers = null, List<string> ignoreProperties = null);
        Task<ODataRequest> CreateInsertRequestAsync(string collection, string commandText, IDictionary<string, object> entryData, bool resultRequired, IDictionary<string, string> headers = null, List<string> ignoreProperties = null);
        Task<ODataRequest> CreateUpdateRequestAsync(string collection, string entryIdent, IDictionary<string, object> entryKey, IDictionary<string, object> entryData, bool resultRequired, IDictionary<string, string> headers = null, List<string> ignoreProperties = null);
